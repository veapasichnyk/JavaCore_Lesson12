...
public class Application {
    ...
    public static void main ( String[] args ) {
        ...
        List <Months> arrayListMonths = new ArrayList <> ( );

        for ( Months monthValue :
                Months.values ( ) ) {
            arrayListMonths.add ( monthValue );
        }

        List <Seasons> arrayListSeasons = new ArrayList <> ( );

        for ( Seasons seasonsValue :
                Seasons.values ( ) ) {
            ...
            switch (scanner.next ( )) {
                ...
                case "5": {
                    ...
                    if ( flag ) {
                        ...
                        if ( ordinal == ( arrayListMonths.size ( ) - 1 ) ) {
                            ordinal = 0;
                            System.out.println ( arrayListSeasons.get ( ordinal ) + "\n" );
                        } else {
                            System.out.println ( arrayListSeasons.get ( ordinal + 1 ) + "\n" );
                        }
                ...
                case "6": {
                    ...
                    if ( flag ) {
                        ...
                        if ( ordinal == 0 ) {
                            ordinal = ( arrayListSeasons.size ( ) - 1 );
                            System.out.println ( arrayListSeasons.get ( ordinal ) + "\n" );
                        } else {
                            System.out.println ( arrayListSeasons.get ( ordinal - 1 ) + "\n" );
                        }
